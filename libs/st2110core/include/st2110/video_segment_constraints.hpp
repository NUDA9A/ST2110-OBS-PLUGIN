...
namespace st2110 {
    ...
    [[nodiscard]] inline std::expected<VideoSegmentConstraints, Error>
    video_segment_constraints(PixelFormat format) {
    ...
    [[nodiscard]] inline Error validate_video_segment_for_format(
            PixelFormat format,
            const SrdHeader& header,
            ByteSpan data) {
