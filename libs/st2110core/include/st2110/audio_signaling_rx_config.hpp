...
namespace st2110 {
    [[nodiscard]] inline std::expected<RxAudioConfig, Error> rx_audio_config_from_audio_stream_signaling(
        ...
        auto samples_per_packet = config_validation::audio_samples_per_packet_from_rate_and_packet_time(
                signaling.media.sampling_rate_hz,
                signaling.media.packet_time_us);
