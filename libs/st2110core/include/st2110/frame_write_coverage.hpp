...
namespace st2110 {
    ...
    public:
        ...
        explicit FrameWriteCoverage(const VideoFrame& frame) {
            reset_from(frame);
        }
        ...
        [[nodiscard]] std::size_t total_expected_bytes() const {
            return total_expected_bytes_;
        }

        [[nodiscard]] std::size_t total_written_unique_bytes() const {
            return total_written_unique_bytes_;
        }
