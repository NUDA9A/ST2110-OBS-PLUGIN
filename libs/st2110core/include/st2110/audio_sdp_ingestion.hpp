...
namespace st2110 {
    [[nodiscard]] inline bool raw_audio_sdp_has_attribute(
            const std::vector<RawAudioSdpAttribute>& attributes,
    ...
    [[nodiscard]] inline Error validate_raw_audio_sdp_required_st2110_clock_signaling(
            const RawAudioSdpMediaSection& raw) {
        const bool has_ts_refclk =
                raw_audio_sdp_has_attribute(raw.unknown_session_attributes, "ts-refclk") ||
        ...
        const bool has_media_level_mediaclk =
                raw_audio_sdp_has_attribute(raw.unknown_attributes, "mediaclk");
    ...
    parse_audio_stream_signaling_from_sdp(
            std::string_view sdp,
        ...
        if (Error err = validate_raw_audio_sdp_required_st2110_clock_signaling(*raw);
                err != Error::Ok) {
