...
namespace st2110 {
    ...
    [[nodiscard]] inline bool has_any_supported_video_sender_type(
    ...
    [[nodiscard]] inline Error validate_video_receiver_timing_capability(
            const VideoReceiverTimingCapability& capability) {
    ...
    [[nodiscard]] inline Error validate_video_receiver_timing_config(
