...
class FrameAssembler {
  public:
    FrameAssembler(uint32_t width, uint32_t height, PixelFormat format,
                   PartialFramePolicy partial_policy = PartialFramePolicy::EmitWithFlag)
    ...
    [[nodiscard]] PartialFramePolicy partial_frame_policy() const { return partial_policy_; }
