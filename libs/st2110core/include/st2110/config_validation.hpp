...
namespace st2110::config_validation {
    ...
    [[nodiscard]] inline std::expected<uint32_t, Error> audio_samples_per_packet_from_rate_and_packet_time(
        ...
        const uint64_t product =
                static_cast<uint64_t>(sampling_rate_hz) *
                static_cast<uint64_t>(packet_time_us);
