...
namespace st2110 {
    ...
    namespace audio_runtime_support {
        inline constexpr auto default_sample_formats = std::array{
                AudioSampleFormat::LinearPcm
        };

        inline constexpr auto default_conformance_ranges = std::array{
    ...
    [[nodiscard]] inline std::expected<AudioMediaDescription, Error> audio_media_description_from_rx_audio_config(
