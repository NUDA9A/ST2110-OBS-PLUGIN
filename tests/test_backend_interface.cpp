...
static_assert(std::is_same_v<decltype(std::declval<st2110::IRxBackend&>().stop()), void>);
...
namespace
{
    ...
    public:
        ...
        void start_video(const st2110::RxVideoConfig& cfg, st2110::IVideoFrameSink& sink) override
        {
            started = true;
    ...
    public:
        ...
        void start_audio(const st2110::RxAudioConfig& cfg, st2110::IAudioFrameSink& sink) override
        {
            started = true;
