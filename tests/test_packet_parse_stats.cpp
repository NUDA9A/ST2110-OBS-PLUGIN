...
static void test_record_packet_parse_result_ok() {
  ...
  st2110::record_packet_parse_result(stats, st2110::Error::Ok, st2110::PacketParseStage::RtpHeader);
...
static void test_record_packet_parse_result_rtp_header_error() {
  ...
  st2110::record_packet_parse_result(stats, st2110::Error::BadRTPVersion, st2110::PacketParseStage::RtpHeader);
...
static void test_record_packet_parse_result_st2110_header_parse_error() {
  ...
  st2110::record_packet_parse_result(stats, st2110::Error::ShortPacket,
...
static void test_record_packet_parse_result_bad_srd() {
  ...
  st2110::record_packet_parse_result(stats, st2110::Error::InvalidValue,
                                     st2110::PacketParseStage::St2110PayloadHeaderValidate);

  st2110::record_packet_parse_result(stats, st2110::Error::Unsupported,
                                     st2110::PacketParseStage::St2110PayloadHeaderValidate);
...
static void test_record_packet_parse_result_srd_payload_split_fail() {
  ...
  st2110::record_packet_parse_result(stats, st2110::Error::ShortPacket, st2110::PacketParseStage::SrdPayloadSplit);
...
static void test_record_packet_parse_result_unknown_error_goes_to_other_error() {
  ...
  st2110::record_packet_parse_result(stats, static_cast<st2110::Error>(999), st2110::PacketParseStage::SrdPayloadSplit);
