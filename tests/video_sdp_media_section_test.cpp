...
static void test_selects_matching_video_media_section() {
    constexpr std::string_view sdp =
            ...
            "a=fmtp:112 sampling=YCbCr-4:2:2; width=1920; height=1080; exactframerate=25; depth=8; PM=2110GPM; SSN=ST2110-20:2022\r\n"
            ...
            "a=fmtp:113 sampling=YCbCr-4:4:4; width=1280; height=720; exactframerate=50; depth=10; PM=2110BPM; SSN=ST2110-20:2022\r\n";
    ...
    assert(section.fmtp == "sampling=YCbCr-4:2:2; width=1920; height=1080; exactframerate=25; depth=8; PM=2110GPM; SSN=ST2110-20:2022");
...
static void test_rejects_payload_type_mismatch() {
    constexpr std::string_view sdp =
            ...
            "a=rtpmap:113 raw/90000\r\n"
            "a=fmtp:113 sampling=YCbCr-4:2:2; width=1920; height=1080; exactframerate=25; depth=8; PM=2110GPM; SSN=ST2110-20:2022\r\n";
...
static void test_rejects_duplicate_relevant_attributes() {
    constexpr std::string_view duplicate_tsmode_sdp =
            "v=0\r\n"
            "m=video 50000 RTP/AVP 112\r\n"
            "a=rtpmap:112 raw/90000\r\n"
            "a=fmtp:112 sampling=YCbCr-4:2:2; width=1920; height=1080; exactframerate=25; depth=8; PM=2110GPM; SSN=ST2110-20:2022\r\n"
    ...
    constexpr std::string_view duplicate_tsdelay_sdp =
            "v=0\r\n"
            "m=video 50000 RTP/AVP 112\r\n"
            "a=rtpmap:112 raw/90000\r\n"
            "a=fmtp:112 sampling=YCbCr-4:2:2; width=1920; height=1080; exactframerate=25; depth=8; PM=2110GPM; SSN=ST2110-20:2022\r\n"
    ...
    constexpr std::string_view duplicate_tp_sdp =
            "v=0\r\n"
            "m=video 50000 RTP/AVP 112\r\n"
            "a=rtpmap:112 raw/90000\r\n"
            "a=fmtp:112 sampling=YCbCr-4:2:2; width=1920; height=1080; exactframerate=25; depth=8; PM=2110GPM; SSN=ST2110-20:2022\r\n"
    ...
    constexpr std::string_view duplicate_troff_sdp =
            "v=0\r\n"
            "m=video 50000 RTP/AVP 112\r\n"
            "a=rtpmap:112 raw/90000\r\n"
            "a=fmtp:112 sampling=YCbCr-4:2:2; width=1920; height=1080; exactframerate=25; depth=8; PM=2110GPM; SSN=ST2110-20:2022\r\n"
    ...
    constexpr std::string_view duplicate_cmax_sdp =
            "v=0\r\n"
            "m=video 50000 RTP/AVP 112\r\n"
            "a=rtpmap:112 raw/90000\r\n"
            "a=fmtp:112 sampling=YCbCr-4:2:2; width=1920; height=1080; exactframerate=25; depth=8; PM=2110GPM; SSN=ST2110-20:2022\r\n"
