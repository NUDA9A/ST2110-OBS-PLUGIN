...
static std::vector<uint8_t> make_packet(bool marker,
    ...
    p.push_back(0x00); p.push_back(0x01);      // seq
    p.push_back(0x00); p.push_back(0x00); p.push_back(0x00); p.push_back(0x2A); // ts
    ...
    p.push_back(0x00); p.push_back(0x04);      // SRD length = 4
