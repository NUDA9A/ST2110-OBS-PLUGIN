...
static void test_parses_aggregate_timing_attributes_from_scoped_session_fields() {
    RawVideoSdpMediaSection raw{};
    raw.session_ts_refclk = RawSdpScopedAttributeValue{
            .value = "ptp=IEEE1588-2008:00-11-22-33-44-55-66-77:127",
            .scope = RawSdpAttributeScope::Session
    };
    raw.session_mediaclk = RawSdpScopedAttributeValue{
            .value = "direct=0",
            .scope = RawSdpAttributeScope::Session
    };
    raw.session_tsmode = RawSdpScopedAttributeValue{
            .value = "NEW",
            .scope = RawSdpAttributeScope::Session
    };
    raw.session_tsdelay = RawSdpScopedAttributeValue{
            .value = "1800",
            .scope = RawSdpAttributeScope::Session
    };
    raw.session_tp = RawSdpScopedAttributeValue{
            .value = "2110TPN",
            .scope = RawSdpAttributeScope::Session
    };
    raw.session_troff = RawSdpScopedAttributeValue{
            .value = "42",
            .scope = RawSdpAttributeScope::Session
    };
    raw.session_cmax = RawSdpScopedAttributeValue{
            .value = "7",
            .scope = RawSdpAttributeScope::Session
    };
...
static void test_media_scoped_timing_values_override_session_scoped_values() {
    ...
    raw.media_mediaclk = RawSdpScopedAttributeValue{
            .value = "direct=0",
    ...
    raw.media_tsmode = RawSdpScopedAttributeValue{
            .value = "PRES",
            .scope = RawSdpAttributeScope::Media
    };
