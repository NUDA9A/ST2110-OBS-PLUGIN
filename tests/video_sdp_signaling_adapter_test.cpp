...
static void test_maps_default_pixel_aspect_ratio_when_absent() {
    auto raw = make_base_raw_fmtp();
    raw.pixel_aspect_ratio = std::nullopt;
...
static void test_maps_explicit_pixel_aspect_ratio() {
    auto raw = make_base_raw_fmtp();
    raw.pixel_aspect_ratio = RawVideoSdpPixelAspectRatio{.width = 1, .height = 1};
...
static void test_maps_non_square_pixel_aspect_ratio() {
    auto raw = make_base_raw_fmtp();
    raw.pixel_aspect_ratio = RawVideoSdpPixelAspectRatio{.width = 12, .height = 11};
...
int main() {
    ...
    test_maps_default_pixel_aspect_ratio_when_absent();
    test_maps_explicit_pixel_aspect_ratio();
    test_maps_non_square_pixel_aspect_ratio();
