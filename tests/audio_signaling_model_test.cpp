...
int main() {
  ...
  static_assert(
      std::is_same_v<decltype(validate_audio_conformance_range(std::declval<const AudioConformanceRange &>())), Error>);

  static_assert(
      std::is_same_v<decltype(audio_media_description_matches_conformance_range(
                         std::declval<const AudioMediaDescription &>(), std::declval<const AudioConformanceRange &>())),
                     bool>);

  static_assert(
      std::is_same_v<decltype(validate_audio_media_description_against_conformance_range(
                         std::declval<const AudioMediaDescription &>(), std::declval<const AudioConformanceRange &>())),
                     Error>);

  static_assert(
      std::is_same_v<
          decltype(validate_audio_channel_order_signaling(std::declval<const AudioChannelOrderSignaling &>())), Error>);
  ...
  constexpr AudioConformanceRange invalid_zero_min_channels{AudioConformanceLevel::LevelA, 48000, 1000, 0, 8};
  static_assert(validate_audio_conformance_range(invalid_zero_min_channels) == Error::InvalidValue);

  constexpr AudioConformanceRange invalid_reversed_channel_range{AudioConformanceLevel::LevelA, 48000, 1000, 8, 1};
  static_assert(validate_audio_conformance_range(invalid_reversed_channel_range) == Error::InvalidValue);

  constexpr AudioConformanceRange invalid_zero_sampling_rate{AudioConformanceLevel::LevelA, 0, 1000, 1, 8};
  static_assert(validate_audio_conformance_range(invalid_zero_sampling_rate) == Error::InvalidValue);

  constexpr AudioConformanceRange invalid_zero_packet_time{AudioConformanceLevel::LevelA, 48000, 0, 1, 8};
  ...
  bad_empty_smpte2110_channel_order.channel_order =
      AudioChannelOrderSignaling{AudioChannelOrderConvention::Smpte2110, ""};
  ...
  bad_smpte2110_channel_order_prefix.channel_order =
      AudioChannelOrderSignaling{AudioChannelOrderConvention::Smpte2110, "AES67.(ST)"};
  ...
  bad_unspecified_channel_order_with_raw_value.channel_order =
      AudioChannelOrderSignaling{AudioChannelOrderConvention::Unspecified, "SMPTE2110.(ST)"};
  ...
  future_unknown_channel_order.channel_order =
      AudioChannelOrderSignaling{AudioChannelOrderConvention::Other, "FUTURECONVENTION.(X)"};
  ...
  bad_empty_future_unknown_channel_order.channel_order =
      AudioChannelOrderSignaling{AudioChannelOrderConvention::Other, ""};
  ...
  invalid_channel_order_convention.channel_order =
      AudioChannelOrderSignaling{static_cast<AudioChannelOrderConvention>(255), "SMPTE2110.(ST)"};
