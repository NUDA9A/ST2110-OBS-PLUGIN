...
static void test_gpm_progressive_uyvy_aligned_segment_maps_successfully() {
    ...
    auto op = st2110::map_video_segment_to_frame_write(st2110::VideoPackingMode::Gpm, st2110::PixelFormat::UYVY,
                                                       st2110::VideoScanMode::Progressive, seg);
...
static void test_gpm_interlaced_mapping_is_still_unsupported() {
    ...
    auto op = st2110::map_video_segment_to_frame_write(st2110::VideoPackingMode::Gpm, st2110::PixelFormat::UYVY,
                                                       st2110::VideoScanMode::Interlaced, seg);
...
static void test_bpm_progressive_mapping_is_explicitly_unsupported() {
    ...
    auto seg = make_segment(0, 0, 4, bytes, sizeof(bytes));
    auto op = st2110::map_video_segment_to_frame_write(st2110::VideoPackingMode::Bpm, st2110::PixelFormat::UYVY,
                                                       st2110::VideoScanMode::Progressive, seg);
