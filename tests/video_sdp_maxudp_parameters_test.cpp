...
static void test_packet_parse_policy_uses_signaled_maxudp() {
    ...
    PacketParsePolicy policy =
            packet_parse_policy_from_video_stream_signaling(*signaling_expected);
...
static void test_absent_maxudp_preserves_default_packet_parse_policy() {
    ...
    PacketParsePolicy policy =
            packet_parse_policy_from_video_stream_signaling(signaling);
